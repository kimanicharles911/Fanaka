...
if($mysqli === false){
  ...
  $sql = "INSERT INTO othercakes (typeofcake, typeofflavor, icingcolordescription,
    ...
    '$fullnames', '$phonenumber', '$email');
    if  ($mysqli->query($sql)){
      echo "Other Cakes Records Added";
    }
    else{
      echo "ERROR Adding Other Cakes Records" .$sql ."<br>" .$mysqli->error;
    }
}
